...
describe("billing account settings", () => {
    ...
    it("sends the selected account and annual cadence, prevents duplicate clicks and preserves the confirmed plan on error", async () => {
        ...
        const choose = screen.getByRole<HTMLButtonElement>("button", { name: "Choose Starter" })
        fireEvent.click(choose)
        fireEvent.click(choose)
        expect(mocks.plan).toHaveBeenCalledExactlyOnceWith({ accountId: "account-one", planId: "starter", cadence: "yearly" })
