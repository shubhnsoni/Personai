...
describe("ChatInterface - live support option", () => {
    it("shows Talk live after the visitor types live chat support", async () => {
        installMatchMedia({ [REDUCE_MOTION]: true })
        vi.stubGlobal(
            "fetch",
        ...
        fireEvent.change(field!, { target: { value: "live chat support" } })
