...
const KIT_SECTIONS = [
    ...
    },
    {
        ...
        eyebrow: "More",
        title: "More trades",
        description: "Same engines, flavoured for common shops and practices. Cafe uses the restaurant kit, clinic uses appointments, plumber uses field service.",
    },
    {
        category: "classic",
        eyebrow: "Original",
