    ...
    return (
        ...
        >
            ...
            <Input
                ...
                className={light ? "h-9 bg-[var(--pdp-white)] text-[var(--pdp-ink)] border-[var(--pdp-line-strong)]" : "h-9 bg-zinc-900"}
            />
            <Textarea
                value={text}
                ...
                className={light ? "bg-[var(--pdp-white)] text-[var(--pdp-ink)] border-[var(--pdp-line-strong)]" : "bg-zinc-900"}
            />
            {photo ? (
                ...
                <label className={light
                    ? "inline-flex cursor-pointer items-center gap-1.5 rounded-full border border-[var(--pdp-line-strong)] px-3 py-1.5 text-xs text-[var(--pdp-fog)]"
