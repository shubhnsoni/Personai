        ...
        <>
            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-end justify-center md:items-center md:p-6">
                    ...
                    <div className="relative max-h-[92dvh] w-full overflow-y-auto rounded-t-[1.75rem] border border-border bg-background p-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[0_-24px_80px_-32px_rgba(15,23,42,0.28)] dark:border-white/10 dark:shadow-[0_-24px_80px_-32px_rgba(0,215,255,0.35)] md:max-w-sm md:rounded-[1.6rem]">
