...
export function ArBuildSheet({ open, onOpenChange, batchId, initialIds = [] }: {
    ...
    return <Sheet open={open} onOpenChange={onOpenChange}><SheetContent side="bottom" className="overflow-y-auto border-border bg-background p-0 text-foreground md:max-w-2xl"><div className="mx-auto mt-2 h-1 w-10 rounded-full bg-current opacity-20 md:hidden" /><div className="mx-auto w-full max-w-2xl px-5 pb-7 pt-6 sm:px-9">
