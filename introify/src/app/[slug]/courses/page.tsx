...
export default async function CoursesCatalogPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        ...
        >
            <CatalogHeader themeToggle={Boolean(catalogTheme)} slug={slug} name={profile.displayName} logoUrl={logo} label="Courses" />
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="space-y-0.5 p-3">
                                        ...
                                        <p className="text-sm tabular-nums" style={{ color: catalogTheme ? "var(--pl-aurora)" : theme.mid || theme.accent }}>
