...
export default async function ShopPage({
    ...
    return (
        ...
        >
            ...
            <SessionProbe slug={slug} />
            <CatalogHeader slug={slug} name={profile.displayName} logoUrl={logo} label={catalogLabel(profile.roleTemplate)} whatsapp={profile.whatsapp} aboutHref={aboutHref} hours={hours} themeToggle />

            <main className="mx-auto max-w-5xl px-3 py-3 pb-10 lg:px-4 lg:py-4">
                {jewelry || wholesale ? (
                    <div className="mb-4 min-w-0 overflow-hidden">
                        <GoldRateStrip board={goldBoard} wholesale={wholesale} surface="shop" />
                    </div>
                ) : null}
                <ShopCatalog
                    slug={slug}
