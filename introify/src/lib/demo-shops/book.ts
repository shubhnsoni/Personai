...
Call 079031 74554. Ask for a cut, hair spa, or facial, and who you want.`,
    ...
    products: [
        // P1-2: omit cross-role home/gym/gift thumbs — ShopCover shows honest PHYSICAL placeholder.
        { title: "Hair oil 100ml", description: "Light oil for the spa and home. Pickup at the Harmu desk.", category: "Hair", priceRupees: 280, sku: "HS-OIL", stock: 18, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Shampoo 200ml", description: "Daily wash. Same bottle we use on the floor.", category: "Hair", priceRupees: 320, sku: "HS-SHAM", stock: 22, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Conditioner 200ml", description: "For the hair spa finish.", category: "Hair", priceRupees: 340, sku: "HS-COND", stock: 16, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Hair serum 50ml", description: "Frizz control after the blow-dry.", category: "Hair", priceRupees: 450, sku: "HS-SER", stock: 12, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Face pack 50g", description: "The pack from the facial trolley.", category: "Skin", priceRupees: 220, sku: "HS-PACK", stock: 14, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Nail colour", description: "One bottle. Desk will match if you bring the old one.", category: "Nails", priceRupees: 180, sku: "HS-NAIL", stock: 20, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
    ],
    story: [
...
Call 086032 92877. Ask for Rakesh, Tarun, or Deepak.`,
    ...
    products: [
        // Gym P1-2: omit cafe/home-decor/gift thumbs + recycled tubs — honest PHYSICAL placeholder on /menu.
        { title: "Whey protein 1kg", description: "Unflavoured. Pickup at the Doranda desk.", category: "Supplements", priceRupees: 2200, sku: "FA-WHEY", stock: 8, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Creatine 300g", description: "Micronised. Desk will tell you the scoop, not a medical claim.", category: "Supplements", priceRupees: 850, sku: "FA-CRE", stock: 10, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "BCAA 250g", description: "For the long evening session.", category: "Supplements", priceRupees: 1100, sku: "FA-BCAA", stock: 6, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Shaker 700ml", description: "Gym-floor bottle.", category: "Gear", priceRupees: 250, sku: "FA-SHK", stock: 15, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Lifting gloves", description: "One pair. Size at the desk.", category: "Gear", priceRupees: 320, sku: "FA-GLV", stock: 12, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Energy bar box", description: "Six bars. Pickup with the session.", category: "Food", priceRupees: 360, sku: "FA-BAR", stock: 9, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
    ],
    story: [
...
Call 077660 05931. Ask for a floor walk, a trainer hour, or what is on the shelf.`,
    ...
    products: [
        // Gym P1-2: omit recycled whey/creatine/floor heroes — honest PHYSICAL placeholder on /menu.
        { title: "Whey protein 1kg", description: "Pickup at Maru Tower. Desk will not write a medical claim.", category: "Supplements", priceRupees: 2400, sku: "AF-WHEY", stock: 10, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Creatine 300g", description: "Micronised. Scoop size at the desk.", category: "Supplements", priceRupees: 890, sku: "AF-CRE", stock: 12, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Pre-workout 250g", description: "Evening batch only if you already train here.", category: "Supplements", priceRupees: 1250, sku: "AF-PRE", stock: 7, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Shaker 700ml", description: "Aura mark on the bottle. Pickup with the session.", category: "Gear", priceRupees: 280, sku: "AF-SHK", stock: 18, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Lifting straps", description: "One pair. For the heavy pulls.", category: "Gear", priceRupees: 220, sku: "AF-STR", stock: 14, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Wrist wraps", description: "One pair. Press days.", category: "Gear", priceRupees: 260, sku: "AF-WRP", stock: 11, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Gym towel", description: "Small. Bring it back or buy another.", category: "Gear", priceRupees: 180, sku: "AF-TOW", stock: 20, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Energy bar box", description: "Six bars. Desk shelf.", category: "Food", priceRupees: 390, sku: "AF-BAR", stock: 9, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
    ],
    story: [],
    documents: [
...
Ask for a night-access briefing, a trainer hour, or an intro before you talk membership. Pickup protein at the same desk.`,
    ...
    products: [
        // Gym P1-2: omit recycled whey/creatine/floor heroes — honest PHYSICAL placeholder on /menu.
        { title: "Whey protein 1kg", description: "Desk shelf. Pickup with your session.", category: "Supplements", priceRupees: 2300, sku: "F24-WHEY", stock: 9, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Creatine 300g", description: "Scoop at the desk. Not a medical claim.", category: "Supplements", priceRupees: 870, sku: "F24-CRE", stock: 11, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Shaker 700ml", description: "Fit24 mark on the bottle.", category: "Gear", priceRupees: 260, sku: "F24-SHK", stock: 16, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Lifting gloves", description: "One pair. Size at the desk.", category: "Gear", priceRupees: 300, sku: "F24-GLV", stock: 13, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Access band", description: "Replacement night band if you lose yours. Members only.", category: "Gear", priceRupees: 150, sku: "F24-BAND", stock: 20, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: false },
        { title: "Gym towel", description: "Bring it. Or buy one.", category: "Gear", priceRupees: 160, sku: "F24-TOW", stock: 18, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Energy bar box", description: "Six bars for the late session.", category: "Food", priceRupees: 360, sku: "F24-BAR", stock: 8, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
    ],
    story: [],
    documents: [
...
Call 090319 99993. Cut is ₹300. Cleanup combo is ₹999.`,
    ...
    products: [
        // P1-2: omit mug/vase/gift-box/gym thumbs — honest PHYSICAL placeholder on /menu.
        { title: "Hair oil 100ml", description: "For the massage and home.", category: "Grooming", priceRupees: 180, sku: "PB-OIL", stock: 20, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Beard oil 30ml", description: "Daily beard. Pickup at the Lalpur desk.", category: "Grooming", priceRupees: 220, sku: "PB-BEARD", stock: 16, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Pomade 50g", description: "Hold after the scissor cut.", category: "Grooming", priceRupees: 260, sku: "PB-POM", stock: 12, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Shampoo 200ml", description: "The bottle from the wash.", category: "Grooming", priceRupees: 240, sku: "PB-SHAM", stock: 14, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
        { title: "Aftershave 50ml", description: "For the cleanup combo finish.", category: "Grooming", priceRupees: 190, sku: "PB-ASH", stock: 10, type: "PHYSICAL", fulfillment: "PHYSICAL", shipMode: "PICKUP", allowCod: true },
    ],
    story: [
