...
import { MK_JEWELLERY_PRODUCT_IMAGES as mkPhoto } from "@/lib/metal/jewelry-imagery"
import { PARAS_AUTO_PRODUCT_IMAGES as paPhoto } from "@/lib/autoparts/auto-parts-imagery"
...
Open every day from 8:00 to 21:00. Landline 0651 233 1077. Ask what is in the sack today, a 5 kg atta, or a packed oil.`,
    ...
    products: [
        { title: "Toor dal 1kg", description: "Loose toor, weighed at the counter. Packed in a poly bag.", category: "Dal", priceRupees: 168, sku: "RG-TOOR-1", stock: 40, weightGrams: 1000, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Moong dal 1kg", description: "Yellow moong, counter scale.", category: "Dal", priceRupees: 154, sku: "RG-MOONG-1", stock: 28, weightGrams: 1000, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Atta 5kg", description: "Packed wheat flour. The evening 5 kg that goes home on a cycle.", category: "Staples", priceRupees: 255, sku: "RG-ATTA-5", stock: 22, weightGrams: 5000, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Rice 5kg", description: "Sonam or similar medium grain. Ask which sack is open.", category: "Staples", priceRupees: 290, sku: "RG-RICE-5", stock: 18, weightGrams: 5000, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Refined oil 1L", description: "Packed sunflower or soy. Brand on the bottle at the shelf.", category: "Oil", priceRupees: 148, sku: "RG-OIL-1", stock: 30, weightGrams: 900, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Ghee 500ml", description: "Packed tin. Keep upright in the bag.", category: "Dairy", priceRupees: 325, sku: "RG-GHEE-500", stock: 14, weightGrams: 500, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Sugar 1kg", description: "Loose crystal, weighed.", category: "Staples", priceRupees: 46, sku: "RG-SUGAR-1", stock: 50, weightGrams: 1000, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Iodised salt 1kg", description: "Packed Tata or similar. Two packets if you ask.", category: "Staples", priceRupees: 28, sku: "RG-SALT-1", stock: 60, weightGrams: 1000, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Tea 250g", description: "CTC leaf, packed. The morning tin refill.", category: "Beverages", priceRupees: 92, sku: "RG-TEA-250", stock: 24, weightGrams: 250, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Sudha milk 500ml", description: "Pouch from the crate. Morning and evening stock; ask before 8pm.", category: "Dairy", priceRupees: 28, sku: "RG-MILK-500", stock: 36, weightGrams: 500, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
    ],
    documents: [
...
Open every day 10:00–21:00. WhatsApp 92048 05839. Landline 0651-2243717.`,
    ...
    products: [
        { title: "Cotton kurti", description: "Everyday cotton, three-quarter sleeve. Size M and L on the rack; S and XL on request.", category: "Kurtis", priceRupees: 890, sku: "FN-KURTI-M", stock: 12, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", highlights: ["Size M–L on rack"] },
        { title: "Kurta palazzo set", description: "Printed kurta with palazzo. Size M. Dupatta in the set.", category: "Sets", priceRupees: 1890, sku: "FN-SET-M", stock: 8, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Banarasi katan saree", description: "Katan silk, zari pallu, kadhua butis. Bridal and festive. Blouse piece attached.", category: "Sarees", priceRupees: 12500, sku: "FN-BAN-KATAN", stock: 4, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Kanjivaram silk saree", description: "Temple border, heavy pallu. Try on the floor; we keep the blouse measurement.", category: "Sarees", priceRupees: 18500, sku: "FN-KANJIV", stock: 3, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Handloom cotton saree", description: "Light drape for a festive Saturday. Contrast border.", category: "Sarees", priceRupees: 2450, sku: "FN-COTTON-SR", stock: 9, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Silk dupatta", description: "Plain silk, 2.5 m. Matches the kurta sets.", category: "Dupattas", priceRupees: 650, sku: "FN-DUP-SILK", stock: 16, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Festive lehenga", description: "Lehenga, choli, and dupatta. Size 38 choli on the rack. Other sizes need two days.", category: "Lehengas", priceRupees: 8500, sku: "FN-LEH-38", stock: 3, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Men's cotton kurta", description: "Straight kurta, size 40 and 42. White and ivory.", category: "Men", priceRupees: 1490, sku: "FN-MEN-40", stock: 10, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Kids festive set", description: "Kurta and pyjama, ages 4–6. One set on the rack in marigold.", category: "Kids", priceRupees: 1290, sku: "FN-KIDS-4", stock: 6, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
        { title: "Blouse piece 1m", description: "Matching silk for the Banarasi and Kanjivaram. Stitch at the floor or take home.", category: "Stitching", priceRupees: 450, sku: "FN-BLOUSE-1", stock: 20, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
    ],
    documents: [
...
Open Monday to Saturday 10:00–20:00. Closed Sunday. Call 93340 63575.`,
    ...
    products: [
        // Clinic P1-2: omit cafe/desk/smoothie thumbs (brand/mug/lassi/lamp) — honest PHYSICAL placeholder on /menu.
        { title: "Paracetamol 650", description: "Strip of 10. Fever and pain. OTC. Batch and expiry on the foil.", category: "Fever", priceRupees: 28, sku: "SM-PCM-650", stock: 40, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("PCM2408", "2027-08-01", 32) },
        { title: "Dolo 650", description: "Strip of 15. Paracetamol 650 mg. OTC.", category: "Fever", priceRupees: 32, sku: "SM-DOLO-650", stock: 28, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("DLO2511", "2027-11-01", 36) },
        { title: "Amoxicillin 500", description: "Capsule strip. Antibiotic. Prescription required.", category: "Antibiotic", priceRupees: 85, sku: "SM-AMX-500", stock: 18, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("AMX2311", "2027-10-15", 92, true) },
        { title: "Azithromycin 500", description: "Three-tablet pack. Prescription required.", category: "Antibiotic", priceRupees: 95, sku: "SM-AZI-500", stock: 12, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("AZI2502", "2027-09-30", 108, true) },
        { title: "Cetirizine 10", description: "Strip of 10. Allergy. OTC.", category: "Allergy", priceRupees: 22, sku: "SM-CET-10", stock: 35, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("CET2406", "2027-12-01", 26) },
        { title: "Cough syrup 100ml", description: "Bottle, measuring cup in the pack. OTC. Keep upright.", category: "Cold", priceRupees: 120, sku: "SM-COU-100", stock: 12, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("COU2501", "2027-06-20", 135) },
        { title: "ORS lemon 21g", description: "One sachet. Mix in a glass of water. OTC.", category: "Hydration", priceRupees: 18, sku: "SM-ORS-21", stock: 48, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("ORS2504", "2028-01-15", 22) },
        { title: "Pantoprazole 40", description: "Strip of 10. Acidity. OTC at this counter; ask if you already take other tablets.", category: "Acidity", priceRupees: 75, sku: "SM-PAN-40", stock: 22, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("PAN2409", "2027-09-01", 82) },
        { title: "Calcium D3", description: "Strip of 15. Supplement. OTC.", category: "Supplement", priceRupees: 110, sku: "SM-CAL-D3", stock: 16, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("CAL2503", "2027-07-01", 125) },
        { title: "Povidone iodine 15g", description: "Antiseptic ointment tube. OTC. For small cuts.", category: "Antiseptic", priceRupees: 85, sku: "SM-PVP-15", stock: 14, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("PVP2505", "2028-03-01", 95) },
        { title: "Metformin 500", description: "Strip of 10. Prescription required.", category: "Diabetes", priceRupees: 42, sku: "SM-MET-500", stock: 20, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: medicine("MET2412", "2027-12-20", 48, true) },
    ],
    documents: [
...
Open Monday to Saturday 8:00–20:00. Closed Sunday. Call 99391 85887.`,
    ...
    products: [
        { title: "Front brake pad", description: "Fits Maruti Swift 2018–2024. Pair for the front axle. Bring the old pad if the year is unclear.", category: "Brakes", priceRupees: 1450, sku: "PA-BP-SWIFT", stock: 8, thumbnailUrl: paPhoto["PA-BP-SWIFT"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Maruti", "Swift", 2018, 2024) },
        { title: "Oil filter", description: "Fits Hyundai i20 2015–2023. Spin-on. Match the old filter thread.", category: "Filters", priceRupees: 280, sku: "PA-OF-I20", stock: 20, thumbnailUrl: paPhoto["PA-OF-I20"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Hyundai", "i20", 2015, 2023) },
        { title: "Battery 35Ah", description: "Fits Maruti Alto 2012–2020. 35Ah, left polarity. Exchange the old battery at the counter.", category: "Electrical", priceRupees: 3850, sku: "PA-BAT-ALTO", stock: 4, thumbnailUrl: paPhoto["PA-BAT-ALTO"], allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Maruti", "Alto", 2012, 2020) },
        { title: "Air filter", description: "Fits Tata Nexon 2020–2024. Panel filter. Tap the dust out only if you are between services.", category: "Filters", priceRupees: 420, sku: "PA-AF-NEXON", stock: 12, thumbnailUrl: paPhoto["PA-AF-NEXON"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Tata", "Nexon", 2020, 2024) },
        { title: "Wiper blade pair", description: "Fits Honda City 2014–2021. Driver and passenger lengths in the pack.", category: "Body", priceRupees: 390, sku: "PA-WP-CITY", stock: 15, thumbnailUrl: paPhoto["PA-WP-CITY"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Honda", "City", 2014, 2021) },
        { title: "Clutch plate", description: "Fits Mahindra Bolero 2011–2019. Driven plate only; pressure plate extra if you ask.", category: "Clutch", priceRupees: 1850, sku: "PA-CP-BOLERO", stock: 5, thumbnailUrl: paPhoto["PA-CP-BOLERO"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Mahindra", "Bolero", 2011, 2019) },
        { title: "Spark plug set (4)", description: "Fits Maruti Swift 2018–2024. Four plugs. Gap as marked on the box.", category: "Engine", priceRupees: 640, sku: "PA-SP-SWIFT", stock: 10, thumbnailUrl: paPhoto["PA-SP-SWIFT"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Maruti", "Swift", 2018, 2024) },
        { title: "Radiator hose", description: "Fits Hyundai i20 2015–2023. Upper hose. Clamp not in the bag unless you ask.", category: "Cooling", priceRupees: 310, sku: "PA-RH-I20", stock: 9, thumbnailUrl: paPhoto["PA-RH-I20"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Hyundai", "i20", 2015, 2023) },
        { title: "Brake disc", description: "Fits Tata Nexon 2020–2024. Front disc, one side. Pair them if both are scored.", category: "Brakes", priceRupees: 2100, sku: "PA-BD-NEXON", stock: 6, thumbnailUrl: paPhoto["PA-BD-NEXON"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Tata", "Nexon", 2020, 2024) },
        { title: "Cabin filter", description: "Fits Honda City 2014–2021. Pollen filter behind the glove box.", category: "Filters", priceRupees: 350, sku: "PA-CF-CITY", stock: 14, thumbnailUrl: paPhoto["PA-CF-CITY"], allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: fitment("Honda", "City", 2014, 2021) },
    ],
    documents: [
...
Open every day 10:15–21:15. Call 99052 92254. mkjewellersmkj.com. Instagram @m.k_jewellers_ranchi.`,
    ...
    products: [
        // JEWELRY P1-2: honest jewellery photography (not PHYSICAL cube / empty PDP gradient).
        { title: "22K light bangle", description: "Hallmarked 22K HUID bangle, 10 g. Ticket is Ranchi city board × weight × purity, plus making.", category: "Bangles", priceRupees: 156000, sku: "MK-BAN-10", stock: 4, thumbnailUrl: mkPhoto["MK-BAN-10"], weightGrams: 10, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(10, K22, 14200) },
        { title: "22K rope chain", description: "22K rope chain, 19 g. Making on the bill. Try length at the counter.", category: "Chains", priceRupees: 292000, sku: "MK-CH-19", stock: 2, thumbnailUrl: mkPhoto["MK-CH-19"], weightGrams: 19, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(19, K22, 22500) },
        { title: "22K gold studs", description: "Pair of 22K studs, 4 g the pair. Screw back.", category: "Earrings", priceRupees: 62000, sku: "MK-ST-4", stock: 6, thumbnailUrl: mkPhoto["MK-ST-4"], weightGrams: 4, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(4, K22, 5600) },
        { title: "22K gold ring", description: "Plain 22K ring, 6 g. Size adjustable at the bench.", category: "Rings", priceRupees: 93000, sku: "MK-RG-6", stock: 5, thumbnailUrl: mkPhoto["MK-RG-6"], weightGrams: 6, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(6, K22, 8500) },
        { title: "22K mangalsutra", description: "Black-bead mangalsutra, 11 g gold. 22K HUID.", category: "Mangalsutra", priceRupees: 171000, sku: "MK-MS-11", stock: 3, thumbnailUrl: mkPhoto["MK-MS-11"], weightGrams: 11, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(11, K22, 15600) },
        { title: "22K pendant", description: "Plain 22K pendant, 5 g. Chain extra.", category: "Pendants", priceRupees: 78000, sku: "MK-PD-5", stock: 4, thumbnailUrl: mkPhoto["MK-PD-5"], weightGrams: 5, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(5, K22, 7100) },
        { title: "22K kada", description: "Gents 22K kada, 17 g. Openable.", category: "Kadas", priceRupees: 262000, sku: "MK-KD-17", stock: 2, thumbnailUrl: mkPhoto["MK-KD-17"], weightGrams: 17, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(17, K22, 20400) },
        { title: "22K gold coin 8g", description: "22K coin, 8 g. Gifting and pooja. Making is low on coins.", category: "Coins", priceRupees: 114000, sku: "MK-COIN-8", stock: 8, thumbnailUrl: mkPhoto["MK-COIN-8"], weightGrams: 8, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(8, K22, 800) },
        { title: "18K diamond ring", description: "18K mount, 3 g gold, IGI stone on the bill. Ticket is board on the gold plus the diamond.", category: "Diamonds", priceRupees: 125000, sku: "MK-DIA-3", stock: 2, thumbnailUrl: mkPhoto["MK-DIA-3"], weightGrams: 3, allowCod: false, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL", variantsJson: gold(3, K18, 12000) },
        { title: "92.5 silver payal", description: "Hallmarked silver payal, 28 g the pair. Not on the gold board — silver rate at the counter.", category: "Silver", priceRupees: 4200, sku: "MK-SL-PAY-28", stock: 5, thumbnailUrl: mkPhoto["MK-SL-PAY-28"], weightGrams: 28, allowCod: true, shipMode: "PICKUP", type: "PHYSICAL", fulfillment: "PHYSICAL" },
    ],
    documents: [
