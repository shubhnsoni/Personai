...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // RECRUIT P1-1 discovery aliases -> LIVE showcase (Nita Recruiters Ashok Nagar).
      // try-agency stays with the separate AGENCY kit (not redirected here).
      { source: "/try-recruit", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-recruit/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-recruitment", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-recruitment/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/recruitment", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/recruitment/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-recruiter", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-recruiter/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/recruiter", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/recruiter/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-hr", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-hr/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/hr", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/hr/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-jobs", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-jobs/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-hiring", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-hiring/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-staffing", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/try-staffing/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/staffing", destination: "/nita-recruiters-ashok-nagar", permanent: false },
      { source: "/staffing/:path*", destination: "/nita-recruiters-ashok-nagar/:path*", permanent: false },
      { source: "/try-talent", destination: "/nita-recruiters-ashok-nagar", permanent: false },
