...
console.log(JSON.stringify({ menuOk, chips, logo, menuLen: menuHtml.length, chatMenuChips: menuChipCount, compileError: /Introify hit a snag|Application error/.test(menuHtml) }, null, 2))
