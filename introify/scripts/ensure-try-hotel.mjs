...
try {
    ...
    console.log(`Try-hotel ensure: created=${result.created}; skipped=${result.skipped.join(",") || "(none)"}; rooms=${rooms}; restaurant=${result.restaurant || "(none)"}; stay=${result.stayToken || "(none)"}; qrs=${qrs}`)
} catch (error) {
