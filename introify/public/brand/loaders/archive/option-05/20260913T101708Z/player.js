...
document.querySelector('.panels').innerHTML=['light','dark'].map(mode=>`<div class="stage ${mode}"><span class="mode">${mode.toUpperCase()}</span>${loader('ticks',mode)}</div>`).join(''); collectProgress();
