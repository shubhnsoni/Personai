...
document.querySelector('.panels').innerHTML=['light','dark'].map(mode=>`<div class="stage ${mode}"><span class="mode">${mode.toUpperCase()}</span>${loader('sun',mode)}</div>`).join(''); collectProgress();
