 ...
 * `BloubBot.vue`, donc hors d'atteinte ΓÇö un `<script setup>` n'exporte rien ΓÇö et
 ...
 * a 1,4 fois le rayon, soit 140. Rien ne les borne au runtime ΓÇö c'est le reglage a la main
