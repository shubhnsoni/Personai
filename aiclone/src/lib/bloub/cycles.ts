 ...
 * regles ΓÇö donnees pures, aucune horloge, aucun import Vue : le meme cycle doit
 ...
 * uniquement parce que 0,6 se trouvait etre le plus long `morph` du catalogue ΓÇö celui
 ...
 * l'utilisateur ΓÇö il s'edite et se stocke comme les autres. La reference, elle,
 ...
 * disparaissait en silence ΓÇö une borne de relecture qui n'est pas aussi une borne d'edition
...
/** `Mon cycle`, `Mon cycle 2`, `Mon cycle 3`... ΓÇö jamais deux fois le meme nom. */
...
function parseBlock(raw: unknown): Block | null {
   ...
   * est deliberement hors du catalogue ΓÇö c'est la transition d'entree des reglages, un
...
function parseCycle(raw: unknown, seen: Cycle[]): Cycle | null {
  ...
  // le nom peut etre vide ΓÇö c'est le montage d'amorce, qui suit la langue
