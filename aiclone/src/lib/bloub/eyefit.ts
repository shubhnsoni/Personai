 ...
 * images par seconde ΓÇö la derive du regard, le pointeur, l'expression en cours de
 ...
 * qui va du contour vers le segment ΓÇö le sens qui degage.
 *
 ...
 * celles qui mettaient le visage a l'echelle rapetissaient les yeux ΓÇö visiblement.
 *
 ...
 * fait que garder son meilleur essai ΓÇö passer ses tours de 40 a 18 suffisait a faire
...
function resous(epreuves: Epreuve[]): { x: number; y: number } {
   ...
   * en plus de n'etre pas plus serree que sur le profil d'origine ΓÇö sans cette seconde
 ...
 * paraissait plus sur ΓÇö un decalage constant ne peut pas bouger quand l'expression change
 * ΓÇö mais il est intenable : sur une capsule, `neutre` a les yeux hauts et demande a
 ...
 * declinent par expression ΓÇö les trois autres etats a corps de base ont un visage releve
 ...
 * stabilite. Un profil inconnu, ou `null`, ne corrige rien ΓÇö l'API accepte n'importe quel
 ...
 * de boule ΓÇö le moteur le remet a son echelle.
 *
