...
export default async function ProductSalesPage({
    ...
    return (
        ...
        >
            ...
            <main className="mx-auto max-w-5xl px-4 py-5 pb-28 lg:px-6 lg:py-6">
                ...
                <div className="flex flex-col gap-5 lg:grid lg:grid-cols-2 lg:items-start lg:gap-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <h1 className="mt-1 text-2xl font-semibold tracking-tight lg:text-xl">{product.title}</h1>
                        {product.subtitle && <p className="mt-1 text-zinc-400">{product.subtitle}</p>}
                        </div>
                        <div className="flex items-end gap-3">
                        <p className="text-3xl font-semibold tabular-nums lg:text-2xl">
                            {wholesale
                                ? "On bill"
                                : jewelry
